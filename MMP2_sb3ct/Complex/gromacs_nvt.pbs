...
#Preprocessing 
#gmx_mpi grompp -f $MDPFILE -c $GROFILE -r $GROFILE -p $TOPOL_FILE -o ${NVT}.tpr -maxwarn 2
...
TEXT="${bell} Hello Arka, PBS Job ${PBS_JOBNAME} exiting @ ${HOSTNAME}:${PBS_O_WORKDIR}. Job ID: ${PBS_JOBID}"
