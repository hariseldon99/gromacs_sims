...
CLI wrapper around gmx_protlig.step2_run_acpype.
"""
...
try:
    from gmx_protlig import step2_run_acpype
except ImportError:
...
def main():
    ...
    parser.add_argument("--net-charge", "--net_charge", type=int, default=0, help="Net charge of ligand (default: 0)")
    parser.add_argument("--charge-method", "--charge_method", type=str, default="bcc", help="Charge method (default: bcc)")
