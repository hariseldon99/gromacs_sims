#!/usr/bin/env python
"""
Uses COBY membrane builder to generate a peptide-membrane system with 1 copy of the KU04AMP01 peptide in a lipid bilayer.
For coarse-grained simulations, the peptide is pre-aligned along the membrane normal (Z-axis) and centered at Z=0.
"""
import COBY
