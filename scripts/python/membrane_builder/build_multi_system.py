#!/usr/bin/env python
"""
Uses COBY membrane builder to generate a multi-peptide system with 12 copies of the KU04AMP01 peptide in a lipid bilayer.
For coarse-grained simulations, the peptides are pre-aligned along the membrane normal (Z-axis) and centered at Z=0.
Use OPM to align peptide: https://opm.phar.umich.edu/ppm_server
"""
