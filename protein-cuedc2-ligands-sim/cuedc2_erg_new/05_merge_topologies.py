...
prot_top = None
for candidate in [
    os.path.join(PROTEIN_TOPDIR, "topol.top"),
    os.path.join(PROTEIN_TOPDIR, "CUEDC2", "topol.top"),
]:
...
complex_sys = gmx.GmxSys(name="cuedc2_erg", coor_file=complex_gro)
